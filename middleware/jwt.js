...
module.exports = {
    ...
    jwtSignin: function (req, res, next,  userId, admin, status ) {
        ...
        console.log("jwtSignin===>>", admin)
        return res.status(200).send({ success: "success", token: token, refresh_token: refreshToken, admin: admin , status: status })
